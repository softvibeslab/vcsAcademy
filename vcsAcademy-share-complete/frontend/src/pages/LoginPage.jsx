    ...
    <div className="min-h-screen bg-[#020204] flex">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        ...
        >
          ...
          <p className="text-[#94A3B8] mb-8">Sign in to continue your journey</p>
      ...
      <div className="hidden lg:block lg:w-1/2 relative">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-[#020204] to-transparent" />
        <div className="absolute inset-0 bg-[#020204]/40" />
        <div className="absolute bottom-12 left-12 right-12">
          <p className="font-serif text-3xl font-semibold leading-tight">
            "The training here changed my career. I went from struggling to being a consistent top producer."
          </p>
          <p className="mt-4 text-[#D4AF37]">— Michael Torres, Top Producer</p>
        </div>
      </div>
    </div>
  );
